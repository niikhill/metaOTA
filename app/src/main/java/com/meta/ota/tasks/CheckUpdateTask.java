...
import com.meta.ota.MainActivity;
import com.meta.ota.R;
import com.meta.ota.configs.AppConfig;
import com.meta.ota.configs.LinkConfig;
import com.meta.ota.configs.OTAConfig;
import com.meta.ota.configs.OTAVersion;
import com.meta.ota.dialogs.WaitDialogHandler;
import com.meta.ota.utils.OTAUtils;
import com.meta.ota.xml.OTADevice;
import com.meta.ota.xml.OTAParser;
...
public class CheckUpdateTask extends AsyncTask<Context, Void, OTADevice> {
    ...
    private void showNotification(Context context) {
        if (mIsBackgroundThread) {
            ...
            int notifyID = 1;
            String id = "metaota_channel";
            CharSequence name = context.getString(R.string.meta_channel);
            String description = context.getString(R.string.meta_channel_description);
            ...
            NotificationCompat.Builder mBuilder = new NotificationCompat.Builder(context.getApplicationContext())
                    .setSmallIcon(R.drawable.ic_notification_meta)
