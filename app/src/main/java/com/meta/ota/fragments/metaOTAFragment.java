...
package com.meta.ota.fragments;
...
import com.meta.ota.dialogs.WaitDialogFragment;
import com.meta.ota.tasks.CheckUpdateTask;
import com.meta.ota.utils.OTAUtils;
import com.meta.ota.xml.OTALink;

import java.util.List;

public class metaOTAFragment extends PreferenceFragment implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.meta_ota);
